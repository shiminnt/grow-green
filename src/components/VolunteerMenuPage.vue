<template>
    <div class="bg">
        ...
        <div class="filter">
            ...
            <label
                ><input type="radio" v-model="time" value="Morning" />
                Morning</label
            >
            <label
                ><input type="radio" v-model="time" value="Afternoon" />
                Afternoon</label
            >
            <label
                ><input type="radio" v-model="time" value="Evening" />
                Evening</label
            >
        </div>
        <ul class="events">
