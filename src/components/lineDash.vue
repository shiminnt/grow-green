                ...
                database
                    ...
                    .then((doc) => {
                        ...
                        for (var i = 0; i < 7; i++) {
                            ...
                            for (
                                var y = 0;
                                y < this.userData.questionsDone.length;
                                y++
                            ) {
                                if (
                                    this.userData.questionsDone[y].date.month ==
                                        d.toLocaleString("default", {
                                            month: "long",
                                        }) &&
                                    this.userData.questionsDone[y].date.day ==
                                        d.getDate()
                                ) {
                            ...
                            for (
                                var x = 0;
                                x < this.userData.articlesRead.length;
                                x++
                            ) {
                                if (
                                    this.userData.articlesRead[x].date.month ==
                                        d.toLocaleString("default", {
                                            month: "long",
                                        }) &&
                                    this.userData.articlesRead[x].date.day ==
                                        d.getDate()
                                ) {
                            ...
                            for (
                                var z = 0;
                                z < this.userData.treeDates.length;
                                z++
                            ) {
                                if (
                                    this.userData.treeDates[z].month ==
                                        d.toLocaleString("default", {
                                            month: "long",
                                        }) &&
                                    this.userData.treeDates[z].day ==
                                        d.getDate()
                                ) {
